...
void MainWindow::on_pushButton_clicked()
{
    ...
    switch(shapeInput)
    {
        ...
        case 0:
        {
            ...
            addLine->setId(canvasUi.getSizing() + 1 );
        ...
        case 1:
        {
            ...
            addPolyLine->setId(canvasUi.getSizing() + 1 );
        ...
        case 2:
        {
            ...
            addPolygon->setId(canvasUi.getSizing() + 1 );
        ...
        case 3:
        {
            ...
            addRect->setId(canvasUi.getSizing() + 1 );
        ...
        case 4:
        {
            ...
            addEllipse->setId(canvasUi.getSizing() + 1 );
