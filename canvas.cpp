...
{
    shapeList.push_back(shapeIn);//Add to vector
    IDCount++;

}

void Canvas::shapeRemove(int indexRemove)
{
    int vecCount = 0;
    bool found = false;
    //Delete operator
...
void Canvas::shapeMove(int indexMove, int coordMove, int x, int y)
{
    int vecCount = 0;
    bool found = false;
    //Delete operator
...
ShapeType Canvas::stringToShapeType(QString shapeTypeStr)
{
    ShapeType shapeTypeEnum;
